...
If you are setting up Android BYOD enrollment for a new client, use the [Roll Out Android Enterprise Work Profiles in Intune](/docs/Configuration/Intune/android-enterprise-work-profile-rollout/) configuration guide.
