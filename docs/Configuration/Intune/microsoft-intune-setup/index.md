...
seo_title: "Microsoft Intune Setup | MDM and MAM Configuration Guide"
description: "Technician guide for basic Microsoft Intune tenant setup, including MDM and MAM user scope, license assignment, company branding, and Android Enterprise rollout links."
keywords: "Microsoft Intune setup, Intune MDM MAM, Intune tenant configuration, Microsoft Endpoint Manager, Intune company branding, Android Enterprise Intune, IT support Vancouver WA, IT support Portland OR, IT support Seattle WA"
canonical: https://help.svetek.com/docs/Configuration/Intune/microsoft-intune-setup/
og_title: "Microsoft Intune Setup"
og_description: "Configure Microsoft Intune MDM/MAM enrollment basics, licensing, company branding, and Android Enterprise rollout paths."
og_type: article
og_image: https://help.svetek.com/images/logo_horizontal_whitetext.svg
og_url: https://help.svetek.com/docs/Configuration/Intune/microsoft-intune-setup/
twitter_title: "Microsoft Intune Setup"
twitter_description: "Technician guide for basic Microsoft Intune tenant setup and enrollment configuration."
...
| Scenario | Guide |
| --- | --- |
| Personal Android phones (BYOD) | [Roll Out Android Enterprise Work Profiles in Intune](/docs/Configuration/Intune/android-enterprise-work-profile-rollout/) |
| Corporate-owned Android devices | [Roll Out Corporate-Owned Android Enterprise Devices in Intune](/docs/Configuration/Intune/android-enterprise-corporate-owned-rollout/) |
