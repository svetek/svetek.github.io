...
canonical: https://help.svetek.com/docs/Configuration/Intune/android-enterprise-corporate-owned-rollout/
...
og_url: https://help.svetek.com/docs/Configuration/Intune/android-enterprise-corporate-owned-rollout/
...
This guide is for company-owned Android devices. For personal Android phones, use the [Android Enterprise work profile rollout guide](/docs/Configuration/Intune/android-enterprise-work-profile-rollout/) and the [Android user enrollment guide](/docs/Guides/Intune/enroll-android-work-profile/).
