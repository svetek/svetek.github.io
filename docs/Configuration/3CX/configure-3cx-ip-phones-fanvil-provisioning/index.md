...
seo_title: "Configure 3CX IP Phones with Fanvil Auto-Provisioning | MSP Guide for Vancouver WA, Portland OR, Seattle WA"
description: "Step-by-step guide to provisioning Fanvil SIP phones on 3CX, including extension setup, firmware updates, Direct SIP settings, and auto-provisioning. VoIP setup support from Svetek IT Experts in Vancouver WA, Portland OR, and Seattle WA."
...
canonical: https://help.svetek.com/docs/Configuration/3CX/configure-3cx-ip-phones-fanvil-provisioning/
og_title: "Configure 3CX IP Phones with Fanvil Auto-Provisioning"
og_description: "Provision Fanvil SIP phones on 3CX with extension setup, firmware update guidance, Direct SIP settings, and auto-provisioning."
og_type: article
og_image: https://help.svetek.com/docs/Configuration/3CX/configure-3cx-ip-phones-fanvil-provisioning/images/3CX_PHONES_FANVIL.png
og_url: https://help.svetek.com/docs/Configuration/3CX/configure-3cx-ip-phones-fanvil-provisioning/
published_time: 2026-06-23T00:00:00+00:00
twitter_title: "Configure 3CX IP Phones with Fanvil Auto-Provisioning"
twitter_description: "Step-by-step Fanvil SIP phone provisioning on 3CX for extension setup, firmware updates, Direct SIP, and auto-provisioning."
twitter_image: https://help.svetek.com/docs/Configuration/3CX/configure-3cx-ip-phones-fanvil-provisioning/images/3CX_PHONES_FANVIL.png
twitter_image_alt: "Fanvil phone auto-provisioning settings in the web interface"
redirect_from:
  - /docs/Configuration/3CX/configure-3cx-ip-phones/
  - /docs/Configuration/3CX/fanvil-provisioning/
layout: docs
---
...
![Fanvil phone MAC address label](images/3CX_PHONES_MAC.png)
...
![3CX add user screen](images/3CX_PHONES_ADD_EXT.png)
...
**Go to Phone Provisioning:** press **Add**, select the IP phone model from the available models, enter the MAC address, and press **OK**.

**In the IP Phone section:** set Provisioning Method to **Direct SIP (STUN - remote)**.

**In Codecs:** move the **G729** codec up the priority list.

To save all changes, press **OK** at the top of the page.
...
![Fanvil auto-provisioning settings](images/3CX_PHONES_FANVIL.png)
