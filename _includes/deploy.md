...
For detailed information, see [Deploy on Kubernetes](/desktop/kubernetes/) and [Describing apps using Kubernetes YAML](/docs/Guides/kube-deploy/#describing-apps-using-kubernetes-yaml).
